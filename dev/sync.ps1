...
# -- 1. Server files --
$ServerFiles = @("pipe_server.py", "rime_pipe.dll", "setup.bat", "start_server.bat", "stop_server.bat")
...
# -- 4. Dev files --
$DevFiles = @("rime_pipe.c", "eval_and_analyze.py", "bench_tok_cand.py", "bench_configs.py", "bench_parallel_mp.py", "LLM服务使用说明.md")
